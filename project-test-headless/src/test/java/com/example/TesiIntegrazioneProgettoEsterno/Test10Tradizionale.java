...
public class Test10Tradizionale {
...
private static StringBuffer verificationErrors = new StringBuffer();
  ...
  @Test
  public void testRicercaTradizionale_release_v_6_0() throws Exception {
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Title'])[1]/following::as-track-main-info[1]")).click();
